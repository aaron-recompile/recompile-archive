...
tags: [bitcoin]
canonical_url: "https://medium.com/@aaron.recompile/how-bitcoin-p2sh-scripts-work-from-2-of-3-multisig-to-timelocked-inheritance-8015010dd6f2"
cover_image: "https://cdn-images-1.medium.com/max/800/1*zen4_zybTJcBr2xsexu5jw.jpeg"
published: false
---

Excerpt from my book *Mastering Taproot* — full chapter.
...
This article is an excerpt from my upcoming book ***Mastering Taproot***, which explores the engineering principles behind Bitcoin’s most advanced scripting upgrade. You can follow the full book’s progress or purchase early-access chapters here:

👉 [[https://leanpub.com/mastering-taproot]](https://leanpub.com/mastering-taproot]%28https://leanpub.com/mastering-taproot%29)
...
```
1. Script Serialization → hex_encoded_script
2. Hash160(script)     → 20_bytes_script_hash  
3. Version + Base58Check → 3...address (mainnet)
```
...
1. Computing Hash160(script)

1. Adding version byte (0x05 for mainnet, 0xc4 for testnet)

1. Applying Base58Check encoding
...
1. **Resets stack**: Back to post-scriptSig state (discards TRUE)

1. **Extracts redeem script**: From original scriptSig data

1. **Prepares clean execution**: For redeem script with signature data
...
1. Bob’s signature verified against Bob’s public key ✓

1. Required threshold (2-of-3) satisfied ✓
...
If you found this chapter useful, you’ll love what comes next: SegWit witness structures, Taproot trees, Merkle path construction, and real testnet path spending with control block analysis.

📘 Keep reading on Leanpub: [Mastering Taproot]([https://leanpub.com/mastering-taproot](https://leanpub.com/mastering-taproot))

📩 You can also follow my updates on Twitter: [[@aaron_recompile](http://twitter.com/aaron_recompile)]([https://twitter.com/aaron_recompile](https://twitter.com/aaron_recompile))

By [Aaron Recompile](https://medium.com/@aaron.recompile) on [July 14, 2025](https://medium.com/p/8015010dd6f2).

[Canonical link](https://medium.com/@aaron.recompile/how-bitcoin-p2sh-scripts-work-from-2-of-3-multisig-to-timelocked-inheritance-8015010dd6f2)
